...
function Dark(el){
  ...
  sidel.style.background="#444444";
  barl.style.background="#6f6f6f";
}
function Light(el){
  ...
  sidel.style.background="#cbcbcb";
  barl.style.background="#c7c7c7";
}



var sidel=document.getElementById('sidel');
var barl=sidel.getElementsByTagName('div');

function Dark1(el){
  for(i=0;i<=barl.length;i++){
    barl[i].style.background="#000000";
  }
}
function Light1(el){
  for(i=0;i<=barl.length;i++){
    barl[i].style.background="#ffffff";
  }
}
blackbtn.addEventListener('click',Dark1);
blackbtn.addEventListener("click", Dark);
whitebtn.addEventListener("click", Light1);
whitebtn.addEventListener("click", Light);
